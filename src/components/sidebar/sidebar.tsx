...
function SideBar()  {
  ...
  return (
    <div className="w-[25%] md:w-[13.5%] h-screen flex-shrink-0 bg-primaryWhite border border-creamWhite">
      ...
      <div className="pt-6 md:pt-32 lg:pt-10 lg:pl-5 flex flex-col gap-4 md:gap-[30px]">
        {paths.map((x) => (
          <div key={x.id}>
            <div
              className={`flex items-center h-8 pl-[7%] md:lg:pl-[10%] cursor-pointer text-capitalize w-full lg:w-[75%] hover:bg-[#5A5A5A] hover:text-[#ffffff]
