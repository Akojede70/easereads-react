...
export const BackButton: React.FC<BackButtonProps> = ({ onClick, className }) => {
  return (
    <button
      onClick={onClick}
      className={`text-[30px] md:text-[18px] cursor-pointer bg-primaryWhite border border-primaryBlack shadow-[0_4px_10px_#e0e0e0] 
        rounded-[15px] w-[150px] md:w-[100px] h-[55px] md:h-[44px] flex items-center justify-center gap-[10px] 
