  ...
  return (
    <Layout name="overview ">
      <div className="w-full pl-[40px]  border flex justify-between border-[#d5d5d5] shadow-[0_4px_10px_#e0e0e0]">
        <div>
          <p className="text-4xl flex flex-col font-bold pt-[30px]">
            {" "}
            Overview
          </p>
          <p className="pt-[10px] pb-[15px] pl-[5px]">
            {" "}
      ...
      <div className="relative w-[98%] h-[225px] bg-[#087cdf] m-[20px] text-white p-4 rounded-lg overflow-hidden flex gap-[290px] ">
        {/* Banner content */}
        <div className="pl-[50px]">
          ...
          <p className="w-[80%] mt-[20px] text-[16px]">
            Get unlimited access to all textbooks, live classes, and AI tutoring
      ...
      <div className=" mt-[20px] bg-gray-100 min-h-screen m-[20px]">
        ...
        <div className="flex gap-[30px]">
          <div className="w-[60%] flex gap-[60px] mb-6">
            <div className="w-[100%] h-[320px] bg-primaryWhite p-4 rounded-[15px] shadow">
              <div className="flex px-4 justify-between">
                <div>
                  <h3 className="text-[16px] font-bold pt-[6px]">
                    Overall performance
                  </h3>
                </div>
          ...
          <div className="w-[35%]  bg-primaryWhite  mb-[20px] rounded-[15px]">
            <p className="pl-[20px] pt-[20px] text-[20px] font-bold">
              {" "}
              Referral Points{" "}
            </p>
            <div className="text-center">
              <p className="text-[20px] pt-[60px] font-bold">
                {" "}
            ...
            <div className="flex gap-[10px]">
              ...
              <div className="flex flex-col gap-[10px]">
                ...
                <div className="flex gap-[15px]">
                  <button className="w-[120px] bg-[#ff9f23] p-2 rounded-[10px] text-primaryWhite">
                    Physics
                  </button>
                  <Dot /> <p> 20 Mins</p>
                  <p> 20 Questions</p>
                ...
                <div>
                  <p>
                    {" "}
                    15th Oct, 2025 <span className="pl-[10px]"> 12:00pm</span>
                  </p>
                </div>
              </div>
              <div className="w-[25%]">
            ...
            <div className="mt-4 space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-green-600">
                  Lvl 12 <span className="text-green-600">▲</span>
                </span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                ...
                <span className="text-green-600">
                  Lvl 10 <span className="text-green-600">▲</span>
                </span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                ...
                <span className="text-red-600">
                  Lvl 9 <span className="text-red-600">▼</span>
                </span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                ...
                <span className="text-green-600">
                  Lvl 5 <span className="text-green-600">▲</span>
                </span>
              </div>
            </div>
          </div>
