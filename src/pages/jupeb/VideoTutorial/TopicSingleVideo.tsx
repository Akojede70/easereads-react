...
import TopicVideoCard from "../../../components/card/TopicVideoCard";
...
const TopicVideoSingle: React.FC = () => {
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <main className="flex-grow px-4 sm:px-6 lg:px-10 py-6 sm:py-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {topics.map((topic) => (
            <TopicVideoCard key={topic.id} topic={topic} />
          ))}
        </div>
      </main>
    </div>
...
export default TopicVideoSingle;